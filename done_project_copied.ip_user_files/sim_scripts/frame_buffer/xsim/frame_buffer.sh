...
#
# Script generated by Vivado on Mon Nov 06 14:13:05 +0200 2023
...
# script info
echo -e "frame_buffer.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot frame_buffer xil_defaultlib.frame_buffer xil_defaultlib.glbl -log elaborate.log
}
