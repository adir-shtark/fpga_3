...
#
# Script generated by Vivado on Thu Sep 21 18:05:50 +0300 2023
...
#
# Usage        : clocking.sh
#                clocking.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clocking.sh [-reset_run]
#                clocking.sh [-reset_log]
#                clocking.sh [-help]
#
...
#                script (type 'clocking.sh -help' for more information).
#
...
# script info
echo -e "clocking.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clocking.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.clocking xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.clocking -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log clocking_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: clocking.sh [-step]\n\
Usage: clocking.sh [-lib_map_path]\n\
Usage: clocking.sh [-reset_run]\n\
Usage: clocking.sh [-reset_log]\n\
Usage: clocking.sh [-keep_index]\n\
