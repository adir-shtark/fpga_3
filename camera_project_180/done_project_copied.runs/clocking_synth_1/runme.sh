...
HD_PWD='C:/Users/Public/Code/vhdl/rotatingProject/done_project_copied/done_project_copied.runs/clocking_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clocking.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clocking.tcl
